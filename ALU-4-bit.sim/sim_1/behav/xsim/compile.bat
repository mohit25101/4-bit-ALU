...
REM
REM Generated by Vivado on Fri Apr 10 22:19:17 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj alu_4bit_vlog.prj"
call xvlog  --incr --relax -L uvm -prj alu_4bit_vlog.prj -log xvlog.log
